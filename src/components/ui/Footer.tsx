    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 min-h-[80px]">
          <span className="text-4xl font-extrabold font-serif text-white">Spread The Word</span>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-zinc-700 py-4 bg-[#708238]">
        <div className="max-w-7xl mx-auto px-4 text-center text-xs text-black">
          &copy; {new Date().getFullYear()} spreadtheword.fr. Tous droits réservés.spreadtheword.fr participe au programme Amazon Services LLC Associates, un programme de publicité d'affiliation conçu pour fournir aux sites un moyen de gagner des frais de publicité en faisant de la publicité et en créant des liens vers Amazon.com.
        </div>
      </div>
    </footer>
  );
